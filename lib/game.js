...
Game.prototype.end = function() {
  ...
  screen.writeText('GAME OVER', 'SCORE: ' + this.points, function() {
    setTimeout(function() {
      screen.cursor.show()
      process.exit()
    }, 2000)
...
Game.prototype.display = function() {
  ...
  // display character
  screen.cursor.goto(10, 21 - self.height).hex('#660066').write(this.character).reset()
